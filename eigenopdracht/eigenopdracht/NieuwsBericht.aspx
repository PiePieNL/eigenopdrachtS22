   ...
   <h2 style="color: #960000">Comments</h2>
    <div class="row">
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <div class="form-group" style="background-color: #D8D8D8">
                        ...
                        <br></br>
                        <p>
                            geplaatst op:<asp:Label runat="server" Text='<%#Eval("Geplaatstop") %>'></asp:Label>
                            <br></br>
                        </p>
                    </div>
        ...
        <div class="col-md-6">
            ...
            <asp:RequiredFieldValidator ID="VDmessage" runat="server" ErrorMessage="a message is needed" ControlToValidate="txtComment"></asp:RequiredFieldValidator>
        </div>
    </div>
